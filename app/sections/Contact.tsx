...
const MailIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>;
const MapIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>;
    ...
    <SectionWrapper id="contact">
      <div className={styles.sectionHeader}>
        ...
        <p className={styles.sectionDesc}>
          Open for opportunities in Offensive Security and Security Research.
          ...
          <div className={`glass-panel ${styles.infoPanel}`}>
            ...
            <div className={styles.infoItems}>
              ...
              <div className={styles.infoItem}>
                ...
                <div>
                  <div className={styles.infoItemLabel}>Location</div>
