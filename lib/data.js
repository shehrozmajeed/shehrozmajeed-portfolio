...
export const profile = {
  ...
  heroHighlights: [
    { text: '[0xA] [Wizard]' },
    { text: '🏆 3× THM League Champion • 🥈 2× THM League Runner-up' },
    { text: '🛡️ THM Jr Penetration Tester', link: 'https://tryhackme-certificates.s3-eu-west-1.amazonaws.com/THM-UKW6TIWKUA.pdf' },
    { text: 'AI Security (THM)', link: 'https://tryhackme.com/certificate/THM-6WTNVFRMRG' },
    { text: "🎓 GIKI '27" },
    { text: '⚙️ Security Tool Developer' },
    { text: 'Top 3% TryHackMe' }
  ],
  summary: [
...
export const stats = [
  { value: 'Top 3%', label: 'Global rank, TryHackMe' },
  { value: '12,000+', label: 'Points earned on TryHackMe' },
  { value: '130+', label: 'Rooms solved' },
  { value: '170+', label: 'Flags captured' },
  { value: '9', label: 'Shipped security & ML projects' },
];

export const thmPaths = [
  { name: 'Jr Penetration Tester', status: 'Path Completed', link: 'https://tryhackme-certificates.s3-eu-west-1.amazonaws.com/THM-UKW6TIWKUA.pdf' },
  { name: 'AI Security', status: 'Path Completed', link: 'https://tryhackme.com/certificate/THM-6WTNVFRMRG' },
];
...
export const certifications = [
  {
    ...
    date: 'Jul 2026',
    expires: 'Jul 2029',
    credentialId: 'THM-UKW6TIWKUA',
    link: 'https://tryhackme-certificates.s3-eu-west-1.amazonaws.com/THM-UKW6TIWKUA.pdf',
    skills: [],
    type: 'certificate',
  },
  {
  ...
  {
    title: '🏆 Platinum League Champion',
    issuer: 'TryHackMe',
    date: null,
    credentialId: null,
    link: 'https://tryhackme.com/shehrozmajeed/badges/platinum-league?utm_campaign=social_share&utm_medium=social&utm_content=badge&utm_source=copy&sharerId=6a2beb12f017a2acc96b1a67',
    skills: [],
    type: 'badge',
  },
  {
    ...
    date: null,
    credentialId: null,
    link: 'https://tryhackme.com/shehrozmajeed/badges/gold-league?utm_campaign=social_share&utm_medium=social&utm_content=badge&utm_source=copy&sharerId=6a2beb12f017a2acc96b1a67',
    skills: [],
    type: 'badge',
  },
  {
  ...
  },
  {
    ...
    issuer: 'Udemy',
    date: null,
    credentialId: 'UC-c852381e-d61f-4daa-af14-b0a4d1b3a4e5',
    link: 'https://www.udemy.com/certificate/UC-c852381e-d61f-4daa-af14-b0a4d1b3a4e5/',
  ...
  },
  {
    ...
    issuer: 'Udemy',
    date: 'Aug 2024',
    credentialId: 'UC-c6a020ba-e255-439d-a2e4-705c8f7d8cf6',
    link: 'https://www.udemy.com/certificate/UC-c6a020ba-e255-439d-a2e4-705c8f7d8cf6/',
